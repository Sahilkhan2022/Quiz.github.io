(function() {
  const myQuestions = [
    ...
    {
      question: "Which of the following is not a part of DevOps lifecycle ___________.",
      answers: {
        a: "Plan",
        b: "Code",
        c: "Build",
    ...
    {
      question: "How does DevOps impact security of an application or machine?",
      answers: {
    ...
    },
    {
    ...
    },
     {
      ...
      answers: {
        ...
        c: "Continuous Monitoring tool",
        d: "Version Control System tool",
       
      },
      correctAnswer: "a"
    },
     {
      question: "DevOps culture is about _______ between Dev and Ops​",
      answers: {
        a: "Collaboration",
        b: "Speed",
        c: "Stability",
     ...
     {
      question: "Ansible is a?",
      answers: {
        a: "Continuous Integration tool",
        b: "Configuration Management and Deployment tools",
        c: "Continuous Monitoring tool",
        d: "Configuration Deployment tools",
     ...
     {
      question: "Which of the following components of the Cloudfront service can be used to distribute contents to users across the globe.",
      answers: {
        a: "Amazon VPC",
        b: "Amazon Regions",
     ...
     {
      question: "Mention some of the useful plugins in Jenkins",
      answers: {
        a: "HTML publisher",
        b: "Copy artifact",
        c: "none of the above",
